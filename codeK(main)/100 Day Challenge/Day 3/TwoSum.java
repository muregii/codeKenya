...
class Solution {
    public int[] twoSum(int[] nums, int target) {
       ...
       for(int i = 0; i < nums.length; i++){
           if(indexToNumber.containsKey(target - nums[i])) //Note that 7 was not yet in our map when i=0. We were yet to put anything in our map. So this condition was only true when i = 0;
